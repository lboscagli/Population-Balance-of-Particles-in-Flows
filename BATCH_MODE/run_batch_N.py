...
import INPS_WRITER_legacy as INPS
...
# batch_params = [
#     {
#         "mode1": dict(GMD=2e-9, GSD=1.3, N0=0e12, rho=1800, kappa=0.5),
...
#             RHi_amb=0.0,
#         ),
#         "label": "H-S-1_G4p6_Ta220"
#     }, 


#     {
#         "mode1": dict(GMD=2e-9, GSD=1.3, N0=2.1e13, rho=1800, kappa=0.5),
#         "mode2": dict(GMD=35e-9, GSD=2.0, N0=1.05e11, rho=1550, kappa=0.005),
#         "Nbins": 35,
#         "threshold_diameter": 80e-9,
#         "ice_params": dict(
...
batch_params = [
    {
        ...
        "label": "H-S-3_centerline_Ta225_Nbins55"
    }, 
]    
# batch_params = [
#     {
#         "mode1": dict(GMD=2e-9, GSD=1.3, N0=0e12, rho=1800, kappa=0.5),
#         "mode2": dict(GMD=35e-9, GSD=2.0, N0=4.469E12, rho=1550, kappa=0.005),
#         "Nbins": 35,
#         "threshold_diameter": 80e-9,
#         "ice_params": dict(
#             p_amb=18753.93,
...
#             RHi_amb=0.0,
#         ),
#         "label": "butanol_centerline_Ta225"
#     },    
#     {
#         "mode1": dict(GMD=2e-9, GSD=1.3, N0=0e12, rho=1800, kappa=0.5),
#         "mode2": dict(GMD=35e-9, GSD=2.0, N0=4.469E12, rho=1550, kappa=0.005),
