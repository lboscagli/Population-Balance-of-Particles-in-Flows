...
batch_params = [
    ...
    },
    {
        ...
        "ice_params": dict(
            ...
            jet_diameter=0.018,
            jet_velocity=88.1,
            jet_temperature=343.75,
            kappa=0.005,
            ss_consumption=True,
            read_inp_distribution=True,
            RHi_amb=0.0,
        ),
        "label": "H-S-1_r4_Ta225"
    },    
    {
        "mode1": dict(GMD=2e-9, GSD=1.3, N0=0e12, rho=1800, kappa=0.5),
        "mode2": dict(GMD=35e-9, GSD=2.0, N0=1.05e11, rho=1550, kappa=0.005),
        ...
        "ice_params": dict(
            ...
            jet_diameter=0.018,
            jet_velocity=38.7,
            jet_temperature=281.1,
            kappa=0.005,
            ss_consumption=True,
            read_inp_distribution=True,
            RHi_amb=0.0,
        ),
        "label": "H-S-1_r5_Ta225"
    },  
    {
        "mode1": dict(GMD=2e-9, GSD=1.3, N0=0e12, rho=1800, kappa=0.5),
        "mode2": dict(GMD=35e-9, GSD=2.0, N0=1.05e11, rho=1550, kappa=0.005),
